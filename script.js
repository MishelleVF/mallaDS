/* 1. Datos de la malla. */
const cursos = [
  { nivel: 1, cod: "CC1101", nombre: "Cálculo de una variable", credito: 4, nota: null, estado: "Pendiente", pre: "" },
  { nivel: 1, cod: "CS1021", nombre: "Matemáticas Discretas I", credito: 4, nota: null, estado: "Pendiente", pre: "" },
  { nivel: 1, cod: "CS1111", nombre: "Programación I", credito: 4, nota: null, estado: "Pendiente", pre: "" },
  { nivel: 1, cod: "DS1000", nombre: "Introducción a Ciencia de Datos", credito: 2, nota: null, estado: "Pendiente", pre: "" },
  { nivel: 1, cod: "HH1101", nombre: "Laboratorio de Comunicación 1", credito: 3, nota: null, estado: "Pendiente", pre: "" },
  { nivel: 1, cod: "PI1101", nombre: "Proyectos Interdisciplinarios 1", credito: 3, nota: null, estado: "Pendiente", pre: "" },

  { nivel: 2, cod: "CC1103", nombre: "Álgebra Lineal", credito: 2, nota: null, estado: "Pendiente", pre: "Cálculo de una variable" },
  { nivel: 2, cod: "CC1104", nombre: "Cálculo Vectorial", credito: 3, nota: null, estado: "Pendiente", pre: "Cálculo de una variable" },
  { nivel: 2, cod: "CC1123", nombre: "Óptica y Ondas", credito: 4, nota: null, estado: "Pendiente", pre: "Cálculo de una variable" },
  { nivel: 2, cod: "CS1022", nombre: "Matemáticas Discretas II", credito: 4, nota: null, estado: "Pendiente", pre: "Matemáticas Discretas I" },
  { nivel: 2, cod: "CS1112", nombre: "Programación II", credito: 4, nota: null, estado: "Pendiente", pre: "Programación I" },
  { nivel: 2, cod: "HH1102", nombre: "Laboratorio de Comunicación 2", credito: 3, nota: null, estado: "Pendiente", pre: "Laboratorio de Comunicación 1" },

  { nivel: 3, cod: "CC1105", nombre: "Estadística y Probabilidades I", credito: 4, nota: null, estado: "Pendiente", pre: "Cálculo de una variable/Programación I" },
  { nivel: 3, cod: "CC2101", nombre: "Ecuaciones Diferenciales", credito: 3, nota: null, estado: "Pendiente", pre: "Cálculo Vectorial" },
  { nivel: 3, cod: "CS2013", nombre: "Programación III", credito: 4, nota: null, estado: "Pendiente", pre: "Programación II" },
  { nivel: 3, cod: "CS2031", nombre: "Desarrollo Basado en Plataformas", credito: 4, nota: null, estado: "Pendiente", pre: "Programación II" },
  { nivel: 3, cod: "CS2041", nombre: "Base de Datos I", credito: 4, nota: null, estado: "Pendiente", pre: "Programación II" },
  { nivel: 3, cod: "PI2102", nombre: "Proyectos Interdisciplinarios 2", credito: 3, nota: null, estado: "Pendiente", pre: "Proyectos Interdisciplinarios 1" },

  { nivel: 4, cod: "CC2102", nombre: "Estadística y Probabilidades II", credito: 4, nota: null, estado: "Pendiente", pre: "Estadística y Probabilidades I" },
  ...
  { nivel: 4, cod: "DS2011", nombre: "Optimización", credito: 4, nota: null, estado: "Pendiente", pre: "Programación II/Cálculo Vectorial" },
  ...
  { nivel: 8, cod: "HH3101", nombre: "Arte y Tecnología", credito: 3, nota: null, estado: "Pendiente", pre: "" },
